...
INSERT INTO "new_order_product" ("costPrice", "createdAt", "createdById", "deletedAt", "discount", "id", "isActive", "price", "productId", "quantity", "sellingPrice", "updatedAt", "updatedById") SELECT "costPrice", "createdAt", "createdById", "deletedAt", "discount", "id", coalesce("isActive", true) AS "isActive", "price", "productId", "quantity", "sellingPrice", "updatedAt", "updatedById" FROM "order_product";
...
INSERT INTO "new_procurement" ("createdAt", "createdById", "deletedAt", "id", "isActive", "payedAt", "price", "productId", "quantity", "updatedAt", "updatedById", "vendorId") SELECT "createdAt", "createdById", "deletedAt", "id", coalesce("isActive", true) AS "isActive", "payedAt", "price", "productId", "quantity", "updatedAt", "updatedById", "vendorId" FROM "procurement";
